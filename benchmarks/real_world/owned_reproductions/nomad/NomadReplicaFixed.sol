...
/// @notice Minimal fixed contrast for the Nomad zero-root acceptance mechanism.
/// @dev This is an explanatory fixture, not the historical patched implementation.
contract NomadReplicaFixed {
